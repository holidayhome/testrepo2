...
public class PreComputeNNs {
    ...
    public void computeAndStoreQueryNNs() throws FileNotFoundException, SAXException, Exception {
        ...
        EnglishAnalyzerWithSmartStopword engAnalyzer = new EnglishAnalyzerWithSmartStopword("/Users/Fernando/Desktop/smart");
        ...
        for (TRECQuery query : queries) {
            ...
            for(int i =0; i < analyzedQuery.length; i++)
            	System.out.print(analyzedQuery[i] + " ");
            System.out.println();
