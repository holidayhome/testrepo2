...
public class TRECQueryParser extends DefaultHandler {
    ...
    public Query getAnalyzedQuery(TRECQuery trecQuery) throws Exception {
    	...
    	//System.out.println("qTitle: " + trecQuery.qtitle);
    	...
    	//Query luceneQuery = new TermQuery(new Term("content", trecQuery.qtitle));
    	//Query luceneQuery = new TermQuery(new Term("contents", trecQuery.qtitle));
...
//            .replaceAll("\\?", " ").replaceAll("\"", " ").replaceAll("\\&", " "), fieldToSearch);
    ...
    public static void main(String[] args) {
        ...
        if (args.length < 1) {
            ...
            args[0] = "/Users/Fernando/Desktop/QE_With_W2V/trec8.xml";
        }

        try {

            EnglishAnalyzerWithSmartStopword obj;
            obj = new EnglishAnalyzerWithSmartStopword("/Users/Fernando/Desktop/stopwords");
